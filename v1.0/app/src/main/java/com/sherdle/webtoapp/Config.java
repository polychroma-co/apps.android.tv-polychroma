...
public class Config {
    ...
    public static final Object[] TITLES = new Object[]{"TV Polychroma"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"http://tv.polychroma.co/mobile/"};
    ...
    public static int SPLASH_SCREEN_DELAY = 20;
